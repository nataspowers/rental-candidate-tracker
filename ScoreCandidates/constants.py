...
restaurant_cat_types = {
    'all' : {
        ...
        'vietnamese':1,'irish':1,'irish_pubs':1,'brasseries':1,
    },
    'joe' : {
        ...
        'desserts':3,'cocktailbars':4,'greek':2,'hawaiian':5,'irish':7,'irish_pubs':7,'brasseries':6,
    },
    'jen' : {
...
observation_types = ['overall-visual','kitchen','bath','livingroom','floors','laundry','parking','street','bonus']
...
neighborhood_scores = {
    ...
    # Lake Merritt
    'Cleveland Heights' : 9,
    'Oakland Avenue/Harrison Street' : 8,
    'Adams Point' : 9,
    'Lakeside' : 9,
    'Merritt' : 9,
    'Trestle Glen' : 9,
    ...
    'Fernside' : 8,
    'South Shore' : 8,
    # EAst of Lake Merritt, all the way out to the Zoo - is this even Oakland?
    'Montclair' : 7,
    'Oak Knoll/Golf Links' : 7,
    'Highland Park' : 8,
    'Arroyo Viejo' : 7,
    'Upper Laurel' : 7,
    'Eastmont Hills' : 7,
    'Highland Terrace' : 7,
    # Fruitvale
    'North Kennedy Tract' : 4,
    'Fruitvale Station' : 4,
    'Havenscourt' : 6,
    'Fremont' : 5,
    'South Kennedy Tract' : 5,

}

#these should not have the global average used if they are missing a value - instead they get 0
missing_okay = ['bonus']
